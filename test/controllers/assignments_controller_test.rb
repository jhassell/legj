...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { committee_id: @assignment.committee_id, member_id: @assignment.member_id } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { committee_id: @assignment.committee_id, member_id: @assignment.member_id } }
